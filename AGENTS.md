...
1. [`docs/FORK_HOOKS.md`](docs/FORK_HOOKS.md) — patch set P1/P3/P4/P5 + mandatory hooks
...
```text
v99.<upstream_version>-plus.<patch>
v99.<upstream_version>-plus.<patch>-<short_sha>
stable
```
