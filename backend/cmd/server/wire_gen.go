...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	kiroTokenProvider := service.ProvideKiroTokenProvider(accountRepository, oAuthRefreshAPI)
	kiroModelDiscoveryService := service.NewKiroModelDiscoveryService(kiroTokenProvider)
	accountHandler := admin.NewAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, kiroModelDiscoveryService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
	...
	imageQuotaHandler := admin.NewImageQuotaHandler(accountRepository)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, paymentHandler, affiliateHandler, imageQuotaHandler)
	...
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, configConfig, kiroTokenProvider)
	openAIImagesV2Handler := handler.NewOpenAIImagesV2Handler(accountRepository, groupRepository, openAIGatewayService, billingCacheService, apiKeyService, usageRecordWorkerPool, settingService, concurrencyService, opsService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, openAIImagesV2Handler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, opsService, idempotencyCoordinator, idempotencyCleanupService)
