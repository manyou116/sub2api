...
func init() {
	...
	// accountDescImageConcurrency is the schema descriptor for image_concurrency field.
	accountDescImageConcurrency := accountFields[8].Descriptor()
	// account.DefaultImageConcurrency holds the default value on creation for the image_concurrency field.
	account.DefaultImageConcurrency = accountDescImageConcurrency.Default.(int)
	...
	groupDescOpenaiLegacyImagesDefault := groupFields[28].Descriptor()
