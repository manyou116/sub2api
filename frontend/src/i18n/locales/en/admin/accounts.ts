export default {
    accounts: {
      ...
      webImages: {
        ...
        requireDownloadAttachment: 'Require original downloadable PNG',
        requireDownloadAttachmentHint: 'Append original-file instructions, wait for a downloadable attachment, and reject compressed previews or wrong-size images.',
        originalAttachmentShort: 'Original',
        ...
        rateLimitedCountdown: 'Rate limited: {time}',
        priority: 'Priority',
        enable: 'Enable',
        disable: 'Disable',
        probe: 'Probe Quota',
      ...
      openai: {
        ...
        planTypeDesc: 'Account subscription plan override.',
        planTypeClear: 'Automatic',
