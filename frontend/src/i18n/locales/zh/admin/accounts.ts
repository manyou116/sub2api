export default {
    accounts: {
      ...
      webImages: {
        ...
        requireDownloadAttachment: '要求原图 PNG 附件',
        requireDownloadAttachmentHint: '自动追加原图文件提示词，等待可下载附件，并拒绝压缩预览图或尺寸不符图片。',
        originalAttachmentShort: '原图',
        ...
        rateLimitedCountdown: '限流倒计时 {time}',
        priority: '优先级',
        enable: '开启',
        disable: '关闭',
        probe: '探测额度',
