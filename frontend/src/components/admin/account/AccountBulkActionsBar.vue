<template>
  <div class="mb-4 flex flex-col gap-2 rounded-lg bg-primary-50 p-3 dark:bg-primary-900/20 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex flex-wrap items-center justify-end gap-2">
      <template v-if="selectedIds.length > 0">
        ...
        <button type="button" @click="$emit('probe-upstream-billing')" class="btn btn-secondary btn-sm">{{ t('admin.accounts.bulkActions.probeUpstreamBilling') }}</button>
