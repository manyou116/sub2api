...
const BADGE: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30 dark:bg-cyan-400/10 dark:text-cyan-300 dark:border-cyan-400/30',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-500/10 text-cyan-700 dark:bg-cyan-400/10 dark:text-cyan-300',
...
const BORDER: Record<Platform, string> = {
  ...
  kiro: 'border-cyan-500/20 dark:border-cyan-400/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  kiro: 'border-cyan-500/35 dark:border-cyan-400/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  kiro: 'bg-gradient-to-r from-cyan-600 to-teal-700',
...
const BUTTON: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-700 text-white hover:bg-cyan-800 active:bg-cyan-900 dark:bg-cyan-600 dark:hover:bg-cyan-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-50 text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200',
...
const GRADIENT: Record<Platform, string> = {
  ...
  kiro: 'from-cyan-600 to-teal-700',
