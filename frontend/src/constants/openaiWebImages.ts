...
export const OPENAI_WEB_IMAGES_MODEL_OPTIONS: OpenAIWebImagesOption[] = [
  ...
  { value: 'gpt-5.6-luna-wm', label: 'GPT-5.6 Luna Work Mode（4K 原图）', planHint: 'plus' },
  { value: 'gpt-5.5', label: 'GPT-5.5', planHint: 'plus' },
...
export const OPENAI_WEB_IMAGES_EFFORT_OPTIONS: OpenAIWebImagesOption[] = [
  { value: 'min', label: 'Min（Work Mode）', planHint: 'all' },
